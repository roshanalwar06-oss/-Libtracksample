...
<head>
    ...
    <title>Manage Members - Lib Track</title>
            ...
            <div class="row min-vh-100">
                ...
                <nav class="col-md-3 col-lg-2 d-md-block bg-dark sidebar py-4 shadow-lg position-fixed h-100" style="z-index:1000;">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a class="nav-link active text-white bg-primary rounded" href="manage_members.php"><i class="bi bi-people me-2"></i>Manage Members</a></li>
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-5 py-5 offset-md-3 offset-lg-2" style="background: linear-gradient(135deg, #232526 0%, #414345 100%); min-height:100vh;">
                    <h1 class="fw-bold text-primary mb-4"><i class="bi bi-people me-2"></i>Manage Members</h1>
                            ...
                            <table class="table table-hover table-striped mb-0 align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_member.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i> Edit</a>
                                            <a href="delete_member.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this member?');"><i class="bi bi-trash"></i> Delete</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
